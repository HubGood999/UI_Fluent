...
function Kavo:ToggleUI()
    if game.Players.LocalPlayer.Character.PlayerGui[LibName].Enabled then
        game.Players.LocalPlayer.Character.PlayerGui[LibName].Enabled = false
    else
        game.Players.LocalPlayer.Character.PlayerGui[LibName].Enabled = true
    end
end
...
function Kavo.CreateLib(kavName, themeList)
    ...
    ScreenGui.Parent = game.Players.LocalPlayer.Character:FindFirstChild("PlayerGui")
