...
[88] = function()
    ...
    return {
        Name = "Glitch Core",
        Accent = Color3.fromRGB(255, 0, 255), -- Neon Purple
        
        AcrylicMain = Color3.fromRGB(20, 10, 30), -- Dark Purple
        AcrylicBorder = Color3.fromRGB(40, 10, 60), -- Darker Purple-Blue
        AcrylicGradient = ColorSequence.new{
            ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 255)), -- Glitch Pink
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 255)), -- Cyan Glitch
            ColorSequenceKeypoint.new(1, Color3.fromRGB(139, 0, 255)) -- Dark Violet
        },
        AcrylicNoise = 0.98,
        
        TitleBarLine = Color3.fromRGB(255, 0, 255), -- Glitch Purple
        Tab = Color3.fromRGB(0, 255, 255), -- Digital Cyan
        
        Element = Color3.fromRGB(30, 10, 40), -- Darker Purple
        ElementBorder = Color3.fromRGB(255, 0, 255), -- Pink Hack Border
        InElementBorder = Color3.fromRGB(0, 255, 255), -- Cyan Glitch Border
        ElementTransparency = 0.85,
        
        ToggleSlider = Color3.fromRGB(139, 0, 255), -- Vibrant Purple
        ToggleToggled = Color3.fromRGB(0, 0, 0), -- Black when Toggled
        
        SliderRail = Color3.fromRGB(255, 0, 255),
        
        DropdownFrame = Color3.fromRGB(30, 10, 40), -- Dark Purple for Dropdown
        DropdownHolder = Color3.fromRGB(20, 5, 30), -- Darker Dropdown Holder
        DropdownBorder = Color3.fromRGB(255, 0, 255), -- Glitch Pink Border
        DropdownOption = Color3.fromRGB(0, 255, 255), -- Cyan for Dropdown Option
        
        Keybind = Color3.fromRGB(0, 255, 255), -- Cyan for Keybind
        
        Input = Color3.fromRGB(255, 0, 255), -- Glitch Pink Input
        InputFocused = Color3.fromRGB(20, 0, 40), -- Dark Purple Focused
        InputIndicator = Color3.fromRGB(0, 255, 255), -- Cyan Input Indicator
        
        Dialog = Color3.fromRGB(30, 10, 40), -- Dark Purple for Dialog
        DialogHolder = Color3.fromRGB(20, 5, 30), -- Darker Dialog Holder
        DialogHolderLine = Color3.fromRGB(20, 0, 40), -- Darker Line for Dialog
        DialogButton = Color3.fromRGB(0, 255, 255), -- Cyan for Dialog Button
        DialogButtonBorder = Color3.fromRGB(255, 0, 255), -- Glitch Pink Border for Button
        DialogBorder = Color3.fromRGB(139, 0, 255), -- Dark Violet Dialog Border
        DialogInput = Color3.fromRGB(0, 255, 255), -- Cyan Input
        DialogInputLine = Color3.fromRGB(255, 0, 255), -- Glitch Pink Input Line
        
        Text = Color3.fromRGB(255, 255, 255), -- White Text
        SubText = Color3.fromRGB(180, 180, 255), -- Light Purple Subtext
        Hover = Color3.fromRGB(255, 0, 255), -- Glitch Pink Hover
        HoverChange = 0.06,
    }
end
