...
local ClosureBindings = {
	...
	[88] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(88)return {
		Name = "Glitch Core",
		Accent = Color3.fromRGB(255, 0, 255), -- ม่วงไฟฟ้า
	
		AcrylicMain = Color3.fromRGB(10, 5, 20), -- ดำม่วงเข้ม
		AcrylicBorder = Color3.fromRGB(40, 20, 80), -- ม่วง-น้ำเงิน
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 255)), -- ชมพูบั๊ก
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 255)), -- ฟ้าบั๊ก
			ColorSequenceKeypoint.new(1, Color3.fromRGB(139, 0, 255)) -- ม่วงแตกๆ
		},
		AcrylicNoise = 0.98,
	
		TitleBarLine = Color3.fromRGB(255, 0, 255), -- ม่วงกลิตช์
		Tab = Color3.fromRGB(0, 255, 255), -- ฟ้าดิจิทัล
	
		Element = Color3.fromRGB(50, 20, 80), -- ม่วงเข้มแตก
		ElementBorder = Color3.fromRGB(255, 0, 255), -- ชมพูแฮก
		InElementBorder = Color3.fromRGB(0, 255, 255), -- ฟ้าบั๊ก
		ElementTransparency = 0.85,
		...
		DropdownFrame = Color3.fromRGB(50, 20, 80),
		DropdownHolder = Color3.fromRGB(30, 10, 60),
		DropdownBorder = Color3.fromRGB(255, 0, 255),
		DropdownOption = Color3.fromRGB(0, 255, 255),
	
		Keybind = Color3.fromRGB(0, 255, 255),
	
		Input = Color3.fromRGB(255, 0, 255),
		InputFocused = Color3.fromRGB(20, 0, 40),
		InputIndicator = Color3.fromRGB(0, 255, 255),
	
		Dialog = Color3.fromRGB(50, 20, 80),
		DialogHolder = Color3.fromRGB(30, 10, 60),
		DialogHolderLine = Color3.fromRGB(20, 0, 40),
		DialogButton = Color3.fromRGB(0, 255, 255),
		DialogButtonBorder = Color3.fromRGB(255, 0, 255),
		DialogBorder = Color3.fromRGB(139, 0, 255),
		DialogInput = Color3.fromRGB(0, 255, 255),
		DialogInputLine = Color3.fromRGB(255, 0, 255),
	
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(200, 200, 255),
		Hover = Color3.fromRGB(255, 0, 255),
		HoverChange = 0.06,
	}
	end,
