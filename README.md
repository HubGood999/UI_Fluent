...
local ClosureBindings = {
	...
	[90] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(48)return {
        Name = "Sunset",
        Accent = Color3.fromRGB(255, 94, 77),
        AcrylicMain = Color3.fromRGB(255, 102, 51),
        AcrylicBorder = Color3.fromRGB(200, 60, 30),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 94, 77), Color3.fromRGB(255, 140, 100)),
        AcrylicNoise = 0.88,
        TitleBarLine = Color3.fromRGB(180, 50, 30),
        Tab = Color3.fromRGB(255, 140, 100),
        Element = Color3.fromRGB(255, 120, 90),
        ElementBorder = Color3.fromRGB(200, 70, 50),
        InElementBorder = Color3.fromRGB(180, 60, 40),
        ElementTransparency = 0.75,
        ToggleSlider = Color3.fromRGB(255, 94, 77),
        ToggleToggled = Color3.fromRGB(180, 50, 30),
        SliderRail = Color3.fromRGB(255, 140, 100),
        DropdownFrame = Color3.fromRGB(255, 102, 51),
        DropdownHolder = Color3.fromRGB(255, 120, 90),
        DropdownBorder = Color3.fromRGB(200, 60, 30),
        DropdownOption = Color3.fromRGB(255, 140, 100),
        Keybind = Color3.fromRGB(255, 140, 100),
        Input = Color3.fromRGB(255, 102, 51),
        InputFocused = Color3.fromRGB(255, 80, 50),
        InputIndicator = Color3.fromRGB(200, 60, 30),
        Dialog = Color3.fromRGB(255, 120, 90),
        DialogHolder = Color3.fromRGB(255, 102, 51),
        DialogHolderLine = Color3.fromRGB(200, 60, 30),
        DialogButton = Color3.fromRGB(255, 94, 77),
        DialogButtonBorder = Color3.fromRGB(180, 50, 30),
        DialogBorder = Color3.fromRGB(160, 40, 20),
        DialogInput = Color3.fromRGB(255, 140, 100),
        DialogInputLine = Color3.fromRGB(255, 80, 50),
        Text = Color3.fromRGB(255, 255, 255),
        SubText = Color3.fromRGB(255, 200, 180),
        Hover = Color3.fromRGB(255, 94, 77),
        HoverChange = 0.06,
		}
	end,
	[91] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(49)return {
        Name = "Dark Mode",
        Accent = Color3.fromRGB(255, 0, 0),
        AcrylicMain = Color3.fromRGB(15, 15, 15),
        AcrylicBorder = Color3.fromRGB(50, 50, 50),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 10, 10), Color3.fromRGB(30, 30, 30)),
        AcrylicNoise = 0.9,
        ...
        ToggleToggled = Color3.fromRGB(100, 0, 0),
        ...
        DialogButtonBorder = Color3.fromRGB(100, 0, 0),
        DialogBorder = Color3.fromRGB(150, 0, 0),
        DialogInput = Color3.fromRGB(40, 40, 40),
        DialogInputLine = Color3.fromRGB(200, 0, 0),
        Text = Color3.fromRGB(255, 255, 255),
	...
	[92] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(50)return {
        Name = "Ocean",
        Accent = Color3.fromRGB(0, 170, 255),
        AcrylicMain = Color3.fromRGB(10, 50, 80),
        AcrylicBorder = Color3.fromRGB(40, 90, 130),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(10, 80, 130), Color3.fromRGB(5, 40, 90)),
        AcrylicNoise = 0.92,
        TitleBarLine = Color3.fromRGB(30, 90, 140),
        Tab = Color3.fromRGB(50, 110, 160),
        Element = Color3.fromRGB(20, 70, 120),
        ElementBorder = Color3.fromRGB(50, 100, 150),
        InElementBorder = Color3.fromRGB(40, 90, 140),
        ElementTransparency = 0.7,
        ToggleSlider = Color3.fromRGB(10, 60, 110),
        ToggleToggled = Color3.fromRGB(0, 150, 255),
        SliderRail = Color3.fromRGB(30, 110, 180),
        DropdownFrame = Color3.fromRGB(10, 60, 110),
        DropdownHolder = Color3.fromRGB(5, 50, 100),
        DropdownBorder = Color3.fromRGB(40, 100, 160),
        DropdownOption = Color3.fromRGB(60, 140, 200),
        Keybind = Color3.fromRGB(100, 170, 220),
        Input = Color3.fromRGB(10, 60, 110),
        InputFocused = Color3.fromRGB(30, 100, 170),
        InputIndicator = Color3.fromRGB(0, 170, 255),
        Dialog = Color3.fromRGB(5, 50, 100),
        DialogHolder = Color3.fromRGB(10, 60, 110),
        DialogHolderLine = Color3.fromRGB(20, 70, 120),
        DialogButton = Color3.fromRGB(40, 110, 180),
        DialogButtonBorder = Color3.fromRGB(50, 130, 200),
        DialogBorder = Color3.fromRGB(60, 150, 220),
        DialogInput = Color3.fromRGB(30, 90, 160),
        DialogInputLine = Color3.fromRGB(40, 110, 180),
	...
	[93] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(51)return {
        Name = "Galaxy",
        Accent = Color3.fromRGB(120, 60, 200),
        AcrylicMain = Color3.fromRGB(10, 10, 30),
        AcrylicBorder = Color3.fromRGB(60, 30, 120),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 20, 100), Color3.fromRGB(20, 10, 70)),
        AcrylicNoise = 0.94,
        TitleBarLine = Color3.fromRGB(80, 40, 160),
        Tab = Color3.fromRGB(100, 50, 180),
        Element = Color3.fromRGB(30, 10, 80),
        ElementBorder = Color3.fromRGB(90, 40, 160),
        InElementBorder = Color3.fromRGB(80, 30, 140),
        ElementTransparency = 0.8,
        ToggleSlider = Color3.fromRGB(50, 20, 140),
        ToggleToggled = Color3.fromRGB(200, 120, 255),
        SliderRail = Color3.fromRGB(120, 60, 220),
        DropdownFrame = Color3.fromRGB(40, 20, 100),
        DropdownHolder = Color3.fromRGB(20, 10, 70),
        DropdownBorder = Color3.fromRGB(90, 40, 160),
        DropdownOption = Color3.fromRGB(150, 80, 240),
        Keybind = Color3.fromRGB(200, 120, 255),
        Input = Color3.fromRGB(30, 10, 80),
        InputFocused = Color3.fromRGB(70, 30, 180),
        InputIndicator = Color3.fromRGB(160, 80, 255),
        Dialog = Color3.fromRGB(20, 10, 70),
        DialogHolder = Color3.fromRGB(30, 10, 80),
        DialogHolderLine = Color3.fromRGB(50, 20, 140),
        DialogButton = Color3.fromRGB(120, 60, 220),
        DialogButtonBorder = Color3.fromRGB(140, 80, 240),
        DialogBorder = Color3.fromRGB(160, 100, 255),
        DialogInput = Color3.fromRGB(100, 50, 200),
        DialogInputLine = Color3.fromRGB(120, 60, 220),
        Text = Color3.fromRGB(230, 210, 255),
        SubText = Color3.fromRGB(180, 150, 230),
        Hover = Color3.fromRGB(200, 120, 255),
        HoverChange = 0.07,
		}
	end,
	[94] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(52)return {
        Name = "Firestorm",
        Accent = Color3.fromRGB(255, 85, 0),
        AcrylicMain = Color3.fromRGB(80, 10, 10),
        AcrylicBorder = Color3.fromRGB(150, 40, 40),
        AcrylicGradient = ColorSequence.new(Color3.fromRGB(200, 60, 20), Color3.fromRGB(150, 30, 10)),
        AcrylicNoise = 0.95,
        TitleBarLine = Color3.fromRGB(180, 50, 20),
        Tab = Color3.fromRGB(200, 70, 30),
        Element = Color3.fromRGB(90, 20, 20),
        ElementBorder = Color3.fromRGB(180, 50, 50),
        InElementBorder = Color3.fromRGB(160, 40, 40),
        ElementTransparency = 0.85,
        ToggleSlider = Color3.fromRGB(140, 30, 30),
        ToggleToggled = Color3.fromRGB(255, 100, 0),
        SliderRail = Color3.fromRGB(200, 80, 40),
        DropdownFrame = Color3.fromRGB(150, 30, 30),
        DropdownHolder = Color3.fromRGB(120, 20, 20),
        DropdownBorder = Color3.fromRGB(180, 50, 50),
        DropdownOption = Color3.fromRGB(250, 90, 30),
        Keybind = Color3.fromRGB(255, 120, 40),
        Input = Color3.fromRGB(80, 10, 10),
        InputFocused = Color3.fromRGB(150, 30, 30),
        InputIndicator = Color3.fromRGB(255, 85, 0),
        Dialog = Color3.fromRGB(120, 20, 20),
        DialogHolder = Color3.fromRGB(90, 10, 10),
        DialogHolderLine = Color3.fromRGB(150, 30, 30),
        DialogButton = Color3.fromRGB(200, 60, 20),
        DialogButtonBorder = Color3.fromRGB(220, 80, 30),
        DialogBorder = Color3.fromRGB(240, 100, 40),
        DialogInput = Color3.fromRGB(180, 50, 20),
        DialogInputLine = Color3.fromRGB(200, 70, 30),
        Text = Color3.fromRGB(255, 220, 200),
        SubText = Color3.fromRGB(220, 180, 160),
        Hover = Color3.fromRGB(255, 100, 0),
        HoverChange = 0.07,
		}
	end,
	[95] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(53)return {
           Name = "Light",
 	...
 	[96] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(52)return {
            Name = "Midnight",
            Accent = Color3.fromRGB(25, 25, 112),
            AcrylicMain = Color3.fromRGB(15, 15, 20),
            AcrylicBorder = Color3.fromRGB(50, 50, 70),
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(5, 5, 10), Color3.fromRGB(10, 10, 30)),
            AcrylicNoise = 0.85,
            TitleBarLine = Color3.fromRGB(30, 30, 50),
            Tab = Color3.fromRGB(45, 45, 75),
            Element = Color3.fromRGB(20, 20, 30),
            ElementBorder = Color3.fromRGB(50, 50, 70),
            InElementBorder = Color3.fromRGB(40, 40, 60),
            ElementTransparency = 0.8,
            ToggleSlider = Color3.fromRGB(10, 10, 40),
            ToggleToggled = Color3.fromRGB(50, 50, 120),
            SliderRail = Color3.fromRGB(35, 35, 85),
            DropdownFrame = Color3.fromRGB(15, 15, 25),
            DropdownHolder = Color3.fromRGB(10, 10, 20),
            DropdownBorder = Color3.fromRGB(40, 40, 60),
            DropdownOption = Color3.fromRGB(60, 60, 100),
            Keybind = Color3.fromRGB(70, 70, 110),
            Input = Color3.fromRGB(10, 10, 20),
            InputFocused = Color3.fromRGB(25, 25, 45),
            InputIndicator = Color3.fromRGB(90, 90, 130),
            Dialog = Color3.fromRGB(5, 5, 15),
            DialogHolder = Color3.fromRGB(10, 10, 20),
            DialogHolderLine = Color3.fromRGB(15, 15, 25),
            DialogButton = Color3.fromRGB(25, 25, 45),
            DialogButtonBorder = Color3.fromRGB(50, 50, 90),
            DialogBorder = Color3.fromRGB(30, 30, 70),
            DialogInput = Color3.fromRGB(40, 40, 80),
            DialogInputLine = Color3.fromRGB(50, 50, 100),
            Text = Color3.fromRGB(180, 180, 255),
            SubText = Color3.fromRGB(120, 120, 200),
            Hover = Color3.fromRGB(90, 90, 180),
            HoverChange = 0.07,
		}
	end,
