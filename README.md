...
local ClosureBindings = {
	...
	[70] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(70)return {
		Name = "Emerald",
		Accent = Color3.fromRGB(55, 180, 90),
	
		AcrylicMain = Color3.fromRGB(30, 40, 30),
		AcrylicBorder = Color3.fromRGB(80, 130, 90),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(60, 190, 135), Color3.fromRGB(50, 165, 70)),
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(85, 140, 105),
		Tab = Color3.fromRGB(140, 180, 160),
	
		Element = Color3.fromRGB(120, 200, 170),
		ElementBorder = Color3.fromRGB(70, 110, 85),
		InElementBorder = Color3.fromRGB(90, 120, 90),
		ElementTransparency = 0.86,
	
		ToggleSlider = Color3.fromRGB(120, 200, 170),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(120, 200, 170),
	
		DropdownFrame = Color3.fromRGB(160, 200, 180),
		DropdownHolder = Color3.fromRGB(50, 120, 75),
		DropdownBorder = Color3.fromRGB(40, 90, 55),
		DropdownOption = Color3.fromRGB(120, 200, 170),
	
		Keybind = Color3.fromRGB(120, 200, 170),
	
		Input = Color3.fromRGB(120, 200, 170),
		InputFocused = Color3.fromRGB(10, 20, 30),
		InputIndicator = Color3.fromRGB(150, 170, 190),
	
		Dialog = Color3.fromRGB(50, 120, 75),
		DialogHolder = Color3.fromRGB(40, 95, 60),
		DialogHolderLine = Color3.fromRGB(35, 90, 55),
		DialogButton = Color3.fromRGB(50, 120, 75),
		DialogButtonBorder = Color3.fromRGB(90, 155, 115),
		DialogBorder = Color3.fromRGB(70, 100, 90),
		DialogInput = Color3.fromRGB(55, 135, 80),
		DialogInputLine = Color3.fromRGB(160, 190, 180),
	
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
		Hover = Color3.fromRGB(120, 200, 170),
		HoverChange = 0.04,
	}
	end,
	[71] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(71)return {
		...
		AcrylicBorder = Color3.fromRGB(130, 60, 60),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(200, 60, 60), Color3.fromRGB(150, 30, 30)),
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(160, 50, 50),
		Tab = Color3.fromRGB(190, 100, 100),
	
		Element = Color3.fromRGB(210, 80, 80),
		ElementBorder = Color3.fromRGB(130, 40, 40),
		InElementBorder = Color3.fromRGB(140, 50, 50),
		ElementTransparency = 0.86,
	
		ToggleSlider = Color3.fromRGB(210, 80, 80),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(210, 80, 80),
	
		DropdownFrame = Color3.fromRGB(190, 100, 100),
		DropdownHolder = Color3.fromRGB(110, 30, 30),
		DropdownBorder = Color3.fromRGB(90, 20, 20),
		DropdownOption = Color3.fromRGB(210, 80, 80),
	
		Keybind = Color3.fromRGB(210, 80, 80),
	
		Input = Color3.fromRGB(210, 80, 80),
		InputFocused = Color3.fromRGB(20, 10, 10),
		InputIndicator = Color3.fromRGB(180, 90, 90),
	
		Dialog = Color3.fromRGB(110, 30, 30),
		DialogHolder = Color3.fromRGB(90, 20, 20),
		DialogHolderLine = Color3.fromRGB(85, 15, 15),
		DialogButton = Color3.fromRGB(110, 30, 30),
		DialogButtonBorder = Color3.fromRGB(160, 50, 50),
		DialogBorder = Color3.fromRGB(100, 40, 40),
		DialogInput = Color3.fromRGB(130, 50, 50),
		DialogInputLine = Color3.fromRGB(190, 100, 100),
	
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(180, 180, 180),
		Hover = Color3.fromRGB(210, 80, 80),
		HoverChange = 0.04,
	}
	end,
	[72] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(72)return {
		...
		AcrylicBorder = Color3.fromRGB(60, 80, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 120, 200), Color3.fromRGB(30, 90, 170)),
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(50, 100, 160),
		Tab = Color3.fromRGB(100, 140, 190),
	
		Element = Color3.fromRGB(80, 150, 210),
		ElementBorder = Color3.fromRGB(40, 90, 130),
		InElementBorder = Color3.fromRGB(50, 100, 140),
		ElementTransparency = 0.86,
	
		ToggleSlider = Color3.fromRGB(80, 150, 210),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(80, 150, 210),
	
		DropdownFrame = Color3.fromRGB(100, 160, 200),
		DropdownHolder = Color3.fromRGB(30, 80, 110),
		DropdownBorder = Color3.fromRGB(20, 60, 90),
		DropdownOption = Color3.fromRGB(80, 150, 210),
	
		Keybind = Color3.fromRGB(80, 150, 210),
	
		Input = Color3.fromRGB(80, 150, 210),
		InputFocused = Color3.fromRGB(10, 10, 30),
		InputIndicator = Color3.fromRGB(90, 140, 180),
	
		Dialog = Color3.fromRGB(30, 80, 110),
		DialogHolder = Color3.fromRGB(20, 60, 90),
		DialogHolderLine = Color3.fromRGB(15, 50, 85),
		DialogButton = Color3.fromRGB(30, 80, 110),
		DialogButtonBorder = Color3.fromRGB(50, 100, 160),
		DialogBorder = Color3.fromRGB(40, 70, 100),
		DialogInput = Color3.fromRGB(50, 90, 130),
		DialogInputLine = Color3.fromRGB(100, 150, 190),
	
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(180, 180, 180),
		Hover = Color3.fromRGB(80, 150, 210),
		HoverChange = 0.04,
	}
	end,
	[73] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(73)return {
		...
		AcrylicBorder = Color3.fromRGB(90, 60, 130),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(140, 70, 200), Color3.fromRGB(110, 50, 170)),
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(120, 60, 160),
		Tab = Color3.fromRGB(160, 120, 190),
	
		Element = Color3.fromRGB(180, 100, 210),
		ElementBorder = Color3.fromRGB(100, 50, 130),
		InElementBorder = Color3.fromRGB(110, 60, 140),
		ElementTransparency = 0.86,
	
		ToggleSlider = Color3.fromRGB(180, 100, 210),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(180, 100, 210),
	
		DropdownFrame = Color3.fromRGB(160, 120, 200),
		DropdownHolder = Color3.fromRGB(70, 40, 110),
		DropdownBorder = Color3.fromRGB(60, 30, 90),
		DropdownOption = Color3.fromRGB(180, 100, 210),
	
		Keybind = Color3.fromRGB(180, 100, 210),
	
		Input = Color3.fromRGB(180, 100, 210),
		InputFocused = Color3.fromRGB(20, 10, 30),
		InputIndicator = Color3.fromRGB(140, 100, 180),
	
		Dialog = Color3.fromRGB(70, 40, 110),
		DialogHolder = Color3.fromRGB(50, 30, 90),
		DialogHolderLine = Color3.fromRGB(40, 20, 85),
		DialogButton = Color3.fromRGB(70, 40, 110),
		DialogButtonBorder = Color3.fromRGB(120, 60, 160),
		DialogBorder = Color3.fromRGB(80, 50, 100),
		DialogInput = Color3.fromRGB(90, 60, 130),
		DialogInputLine = Color3.fromRGB(140, 100, 180),
	
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(180, 180, 180),
		Hover = Color3.fromRGB(180, 100, 210),
		HoverChange = 0.04,
	}
	end,
	[74] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(74)return {
		Name = "Topaz",
		Accent = Color3.fromRGB(230, 140, 40),
	
		AcrylicMain = Color3.fromRGB(50, 30, 20),
		AcrylicBorder = Color3.fromRGB(160, 100, 50),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(240, 150, 50), Color3.fromRGB(200, 120, 40)),
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(200, 120, 50),
		Tab = Color3.fromRGB(230, 160, 80),
	
		Element = Color3.fromRGB(240, 180, 90),
		ElementBorder = Color3.fromRGB(180, 90, 40),
		InElementBorder = Color3.fromRGB(190, 100, 50),
		ElementTransparency = 0.86,
	
		ToggleSlider = Color3.fromRGB(240, 180, 90),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(240, 180, 90),
	
		DropdownFrame = Color3.fromRGB(220, 150, 80),
		DropdownHolder = Color3.fromRGB(110, 60, 30),
		DropdownBorder = Color3.fromRGB(90, 40, 20),
		DropdownOption = Color3.fromRGB(240, 180, 90),
	
		Keybind = Color3.fromRGB(240, 180, 90),
	
		Input = Color3.fromRGB(240, 180, 90),
		InputFocused = Color3.fromRGB(30, 20, 10),
		InputIndicator = Color3.fromRGB(200, 150, 100),
	
		Dialog = Color3.fromRGB(110, 60, 30),
		DialogHolder = Color3.fromRGB(90, 40, 20),
		DialogHolderLine = Color3.fromRGB(85, 30, 15),
		DialogButton = Color3.fromRGB(110, 60, 30),
		DialogButtonBorder = Color3.fromRGB(200, 120, 50),
		DialogBorder = Color3.fromRGB(120, 80, 40),
		DialogInput = Color3.fromRGB(140, 90, 50),
		DialogInputLine = Color3.fromRGB(220, 160, 100),
	
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(200, 200, 180),
		Hover = Color3.fromRGB(240, 180, 90),
		HoverChange = 0.04,
	}
	end,
	[75] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(75)return {
		...
		Tab = Color3.fromRGB(70, 70, 90),
	
		Element = Color3.fromRGB(60, 60, 80),
		ElementBorder = Color3.fromRGB(40, 40, 50),
		InElementBorder = Color3.fromRGB(50, 50, 60),
		ElementTransparency = 0.88,
	
		ToggleSlider = Color3.fromRGB(60, 60, 80),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(60, 60, 80),
	
		DropdownFrame = Color3.fromRGB(50, 50, 70),
		...
		Input = Color3.fromRGB(60, 60, 80),
		InputFocused = Color3.fromRGB(20, 20, 30),
		InputIndicator = Color3.fromRGB(90, 90, 110),
	
		Dialog = Color3.fromRGB(30, 30, 40),
		DialogHolder = Color3.fromRGB(25, 25, 35),
		DialogHolderLine = Color3.fromRGB(20, 20, 30),
		DialogButton = Color3.fromRGB(30, 30, 40),
		DialogButtonBorder = Color3.fromRGB(70, 70, 90),
		DialogBorder = Color3.fromRGB(50, 50, 60),
	...
	[76] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(76)return {
		...
		AcrylicMain = Color3.fromRGB(50, 40, 20),
		AcrylicBorder = Color3.fromRGB(180, 140, 50),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(255, 215, 70), Color3.fromRGB(230, 180, 60)),
		AcrylicNoise = 0.90,
	
		TitleBarLine = Color3.fromRGB(230, 180, 60),
		Tab = Color3.fromRGB(250, 210, 80),
	
		Element = Color3.fromRGB(255, 230, 90),
		ElementBorder = Color3.fromRGB(200, 150, 50),
		InElementBorder = Color3.fromRGB(210, 160, 60),
		ElementTransparency = 0.85,
	
		ToggleSlider = Color3.fromRGB(255, 230, 90),
		ToggleToggled = Color3.fromRGB(50, 30, 10),
	
		SliderRail = Color3.fromRGB(255, 230, 90),
	
		DropdownFrame = Color3.fromRGB(240, 200, 80),
		DropdownHolder = Color3.fromRGB(120, 90, 40),
		DropdownBorder = Color3.fromRGB(100, 70, 30),
		DropdownOption = Color3.fromRGB(255, 230, 90),
	
		Keybind = Color3.fromRGB(255, 230, 90),
	
		Input = Color3.fromRGB(255, 230, 90),
		InputFocused = Color3.fromRGB(40, 30, 10),
		InputIndicator = Color3.fromRGB(220, 180, 100),
	
		Dialog = Color3.fromRGB(120, 90, 40),
		DialogHolder = Color3.fromRGB(100, 70, 30),
		DialogHolderLine = Color3.fromRGB(90, 50, 20),
		DialogButton = Color3.fromRGB(120, 90, 40),
		DialogButtonBorder = Color3.fromRGB(230, 180, 60),
		DialogBorder = Color3.fromRGB(140, 110, 50),
		DialogInput = Color3.fromRGB(160, 120, 60),
		DialogInputLine = Color3.fromRGB(240, 200, 100),
	
		Text = Color3.fromRGB(255, 255, 230),
		SubText = Color3.fromRGB(230, 220, 200),
		Hover = Color3.fromRGB(255, 230, 90),
		HoverChange = 0.04,
	}
	end,
	[77] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(77)return {
		...
		AcrylicMain = Color3.fromRGB(40, 10, 15),
		AcrylicBorder = Color3.fromRGB(100, 30, 40),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(160, 20, 40), Color3.fromRGB(100, 10, 20)),
		AcrylicNoise = 0.88,
	
		TitleBarLine = Color3.fromRGB(160, 30, 50),
		Tab = Color3.fromRGB(200, 50, 70),
	
		Element = Color3.fromRGB(220, 80, 100),
		ElementBorder = Color3.fromRGB(160, 40, 60),
		InElementBorder = Color3.fromRGB(170, 50, 70),
		ElementTransparency = 0.84,
	
		ToggleSlider = Color3.fromRGB(220, 80, 100),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(220, 80, 100),
	
		DropdownFrame = Color3.fromRGB(200, 60, 80),
		DropdownHolder = Color3.fromRGB(90, 20, 30),
		DropdownBorder = Color3.fromRGB(70, 10, 20),
		DropdownOption = Color3.fromRGB(220, 80, 100),
	
		Keybind = Color3.fromRGB(220, 80, 100),
	
		Input = Color3.fromRGB(220, 80, 100),
		InputFocused = Color3.fromRGB(40, 10, 15),
		InputIndicator = Color3.fromRGB(180, 60, 80),
	
		Dialog = Color3.fromRGB(90, 20, 30),
		DialogHolder = Color3.fromRGB(70, 10, 20),
		DialogHolderLine = Color3.fromRGB(60, 10, 20),
		DialogButton = Color3.fromRGB(90, 20, 30),
		DialogButtonBorder = Color3.fromRGB(160, 30, 50),
		DialogBorder = Color3.fromRGB(110, 30, 50),
		DialogInput = Color3.fromRGB(130, 40, 60),
		DialogInputLine = Color3.fromRGB(200, 70, 90),
	
		Text = Color3.fromRGB(255, 230, 230),
		SubText = Color3.fromRGB(220, 200, 200),
		Hover = Color3.fromRGB(220, 80, 100),
		HoverChange = 0.05,
	}
	end,
	[78] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(78)return {
		Name = "Cosmic",
		Accent = Color3.fromRGB(120, 80, 180),
	
		AcrylicMain = Color3.fromRGB(10, 10, 30),
		AcrylicBorder = Color3.fromRGB(50, 20, 90),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 10, 80), Color3.fromRGB(20, 10, 50)),
		AcrylicNoise = 0.93,
	
		TitleBarLine = Color3.fromRGB(90, 50, 160),
		Tab = Color3.fromRGB(140, 100, 200),
	
		Element = Color3.fromRGB(160, 120, 220),
		ElementBorder = Color3.fromRGB(110, 80, 180),
		InElementBorder = Color3.fromRGB(120, 90, 190),
		ElementTransparency = 0.82,
	
		ToggleSlider = Color3.fromRGB(160, 120, 220),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(160, 120, 220),
	
		DropdownFrame = Color3.fromRGB(140, 100, 200),
		DropdownHolder = Color3.fromRGB(60, 40, 110),
		DropdownBorder = Color3.fromRGB(50, 30, 90),
		DropdownOption = Color3.fromRGB(160, 120, 220),
	
		Keybind = Color3.fromRGB(160, 120, 220),
	
		Input = Color3.fromRGB(160, 120, 220),
		InputFocused = Color3.fromRGB(20, 10, 50),
		InputIndicator = Color3.fromRGB(120, 90, 170),
	
		Dialog = Color3.fromRGB(60, 40, 110),
		DialogHolder = Color3.fromRGB(50, 30, 90),
		DialogHolderLine = Color3.fromRGB(40, 20, 80),
		DialogButton = Color3.fromRGB(60, 40, 110),
		DialogButtonBorder = Color3.fromRGB(90, 50, 160),
		DialogBorder = Color3.fromRGB(80, 40, 140),
		DialogInput = Color3.fromRGB(100, 60, 170),
		DialogInputLine = Color3.fromRGB(140, 100, 200),
	
		Text = Color3.fromRGB(220, 220, 255),
		SubText = Color3.fromRGB(180, 180, 220),
		Hover = Color3.fromRGB(160, 120, 220),
		HoverChange = 0.05,
	}
	end,
	[79] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(79)return {
		Name = "Rainbow",
		Accent = Color3.fromRGB(255, 100, 100), -- สีแดงหลัก
	
		AcrylicMain = Color3.fromRGB(50, 50, 50),
		AcrylicBorder = Color3.fromRGB(150, 150, 150),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 0)),   -- แดง
			ColorSequenceKeypoint.new(0.16, Color3.fromRGB(255, 165, 0)), -- ส้ม
		...
		TitleBarLine = Color3.fromRGB(255, 165, 0), -- ส้ม
		Tab = Color3.fromRGB(255, 255, 0), -- เหลือง
	
		Element = Color3.fromRGB(0, 255, 0), -- เขียว
		ElementBorder = Color3.fromRGB(0, 0, 255), -- น้ำเงิน
		InElementBorder = Color3.fromRGB(75, 0, 130), -- คราม
		ElementTransparency = 0.85,
	
		ToggleSlider = Color3.fromRGB(255, 0, 0), -- แดง
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(255, 100, 100), -- ชมพูแดง
	
		DropdownFrame = Color3.fromRGB(255, 255, 0), -- เหลือง
		DropdownHolder = Color3.fromRGB(0, 255, 0), -- เขียว
		DropdownBorder = Color3.fromRGB(0, 0, 255), -- น้ำเงิน
		DropdownOption = Color3.fromRGB(255, 0, 0), -- แดง
	
		Keybind = Color3.fromRGB(148, 0, 211), -- ม่วง
	
		Input = Color3.fromRGB(0, 255, 255), -- ฟ้า
		InputFocused = Color3.fromRGB(50, 50, 50),
		InputIndicator = Color3.fromRGB(255, 100, 100),
	
		Dialog = Color3.fromRGB(75, 0, 130), -- คราม
		DialogHolder = Color3.fromRGB(50, 50, 50),
		DialogHolderLine = Color3.fromRGB(40, 40, 40),
		DialogButton = Color3.fromRGB(255, 100, 100),
		DialogButtonBorder = Color3.fromRGB(255, 165, 0),
		DialogBorder = Color3.fromRGB(200, 100, 255),
		DialogInput = Color3.fromRGB(255, 0, 255),
	...
	[80] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(80)return {
		Name = "Pastel Rainbow",
		Accent = Color3.fromRGB(255, 182, 193), -- ชมพูพาสเทล
	
		AcrylicMain = Color3.fromRGB(245, 245, 250),
		AcrylicBorder = Color3.fromRGB(220, 220, 230),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 182, 193)), -- ชมพูอ่อน
			ColorSequenceKeypoint.new(0.16, Color3.fromRGB(255, 223, 186)), -- ส้มพาสเทล
			ColorSequenceKeypoint.new(0.33, Color3.fromRGB(255, 255, 186)), -- เหลืองพาสเทล
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(186, 255, 201)), -- เขียวมิ้นต์
			ColorSequenceKeypoint.new(0.66, Color3.fromRGB(186, 225, 255)), -- ฟ้าพาสเทล
			ColorSequenceKeypoint.new(0.83, Color3.fromRGB(215, 186, 255)), -- ม่วงพาสเทล
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 200, 245)) -- ชมพูม่วงพาสเทล
		},
		AcrylicNoise = 0.85,
	
		TitleBarLine = Color3.fromRGB(255, 200, 230),
		Tab = Color3.fromRGB(255, 223, 186),
	
		Element = Color3.fromRGB(186, 255, 201),
		ElementBorder = Color3.fromRGB(186, 225, 255),
		InElementBorder = Color3.fromRGB(215, 186, 255),
		ElementTransparency = 0.90,
	
		ToggleSlider = Color3.fromRGB(255, 182, 193),
		ToggleToggled = Color3.fromRGB(220, 220, 220),
	
		SliderRail = Color3.fromRGB(255, 200, 245),
	
		DropdownFrame = Color3.fromRGB(255, 223, 186),
		DropdownHolder = Color3.fromRGB(230, 230, 250),
		DropdownBorder = Color3.fromRGB(215, 186, 255),
		DropdownOption = Color3.fromRGB(186, 255, 201),
	
		Keybind = Color3.fromRGB(186, 225, 255),
	
		Input = Color3.fromRGB(255, 182, 193),
		InputFocused = Color3.fromRGB(245, 245, 250),
		InputIndicator = Color3.fromRGB(255, 200, 245),
	
		Dialog = Color3.fromRGB(230, 230, 250),
		DialogHolder = Color3.fromRGB(220, 220, 230),
		DialogHolderLine = Color3.fromRGB(200, 200, 220),
		DialogButton = Color3.fromRGB(255, 223, 186),
		DialogButtonBorder = Color3.fromRGB(255, 182, 193),
		DialogBorder = Color3.fromRGB(186, 225, 255),
		DialogInput = Color3.fromRGB(215, 186, 255),
		DialogInputLine = Color3.fromRGB(186, 255, 201),
	
		Text = Color3.fromRGB(80, 80, 80),
		SubText = Color3.fromRGB(140, 140, 140),
		Hover = Color3.fromRGB(255, 223, 186),
		HoverChange = 0.06,
	}
	end,
	[81] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(81)return {
		Name = "Void",
		Accent = Color3.fromRGB(20, 20, 20), -- ดำเข้ม
	
		AcrylicMain = Color3.fromRGB(10, 10, 10),
		AcrylicBorder = Color3.fromRGB(30, 30, 30),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(10, 10, 10)), -- ดำสนิท
			ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 30, 30)) -- เทาเข้ม
		},
		AcrylicNoise = 0.97,
	...
	[82] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(82)return {
		Name = "Royal Gold",
		Accent = Color3.fromRGB(255, 215, 0), -- สีทอง
	
		AcrylicMain = Color3.fromRGB(20, 20, 20), -- ดำด้าน
		AcrylicBorder = Color3.fromRGB(60, 60, 60),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 30, 30)), -- ดำลึก
			ColorSequenceKeypoint.new(1, Color3.fromRGB(80, 80, 80)) -- เทาเข้มเงา
		},
		AcrylicNoise = 0.95,
	
		TitleBarLine = Color3.fromRGB(200, 160, 40), -- ทองคลาสสิก
		Tab = Color3.fromRGB(240, 200, 60), -- ทองสดใส
	
		Element = Color3.fromRGB(255, 215, 100), -- ทองอ่อน
		ElementBorder = Color3.fromRGB(200, 160, 40), -- ทองเข้ม
		InElementBorder = Color3.fromRGB(180, 140, 30), -- ทองลึก
		ElementTransparency = 0.85,
	
		ToggleSlider = Color3.fromRGB(255, 215, 100),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(255, 215, 100),
	
		DropdownFrame = Color3.fromRGB(220, 180, 50),
		DropdownHolder = Color3.fromRGB(60, 60, 60),
		DropdownBorder = Color3.fromRGB(50, 50, 50),
		DropdownOption = Color3.fromRGB(255, 215, 100),
	
		Keybind = Color3.fromRGB(255, 215, 100),
	
		Input = Color3.fromRGB(255, 215, 100),
		InputFocused = Color3.fromRGB(40, 40, 40),
		InputIndicator = Color3.fromRGB(220, 180, 80),
	
		Dialog = Color3.fromRGB(60, 60, 60),
		DialogHolder = Color3.fromRGB(50, 50, 50),
		DialogHolderLine = Color3.fromRGB(40, 40, 40),
		DialogButton = Color3.fromRGB(80, 80, 80),
		DialogButtonBorder = Color3.fromRGB(240, 200, 60),
		DialogBorder = Color3.fromRGB(200, 160, 40),
		DialogInput = Color3.fromRGB(180, 140, 30),
		DialogInputLine = Color3.fromRGB(255, 215, 100),
	
		Text = Color3.fromRGB(255, 255, 230), -- ขาวทอง
		SubText = Color3.fromRGB(200, 200, 180),
		Hover = Color3.fromRGB(255, 215, 100),
		HoverChange = 0.04,
	}
	end,
	[83] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(83)return {
		Name = "Platinum",
		Accent = Color3.fromRGB(200, 200, 210), -- เงินอ่อน
	
		AcrylicMain = Color3.fromRGB(240, 240, 245), -- เทาเงิน
		AcrylicBorder = Color3.fromRGB(200, 200, 210),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(220, 220, 230)), -- เทาเงินอ่อน
			ColorSequenceKeypoint.new(1, Color3.fromRGB(180, 180, 190)) -- เทาเข้มแพลตตินั่ม
		},
		AcrylicNoise = 0.90,
	
		TitleBarLine = Color3.fromRGB(160, 160, 180), -- เทาแพลตตินั่มเข้ม
		Tab = Color3.fromRGB(220, 220, 230), -- เงินอ่อน
	
		Element = Color3.fromRGB(230, 230, 240), -- เทาเงินกลาง
		ElementBorder = Color3.fromRGB(190, 190, 200), -- เทาเงินเข้ม
		InElementBorder = Color3.fromRGB(170, 170, 190), -- เทาเงินลึก
		ElementTransparency = 0.87,
	
		ToggleSlider = Color3.fromRGB(230, 230, 240),
		ToggleToggled = Color3.fromRGB(50, 50, 60),
	
		SliderRail = Color3.fromRGB(230, 230, 240),
	
		DropdownFrame = Color3.fromRGB(210, 210, 225),
		DropdownHolder = Color3.fromRGB(180, 180, 190),
		DropdownBorder = Color3.fromRGB(160, 160, 180),
		DropdownOption = Color3.fromRGB(230, 230, 240),
	
		Keybind = Color3.fromRGB(230, 230, 240),
	
		Input = Color3.fromRGB(230, 230, 240),
		InputFocused = Color3.fromRGB(200, 200, 210),
		InputIndicator = Color3.fromRGB(180, 180, 200),
	
		Dialog = Color3.fromRGB(200, 200, 210),
		DialogHolder = Color3.fromRGB(180, 180, 190),
		DialogHolderLine = Color3.fromRGB(160, 160, 180),
		DialogButton = Color3.fromRGB(190, 190, 200),
		DialogButtonBorder = Color3.fromRGB(220, 220, 230),
		DialogBorder = Color3.fromRGB(200, 200, 210),
		DialogInput = Color3.fromRGB(190, 190, 200),
		DialogInputLine = Color3.fromRGB(230, 230, 240),
	
		Text = Color3.fromRGB(50, 50, 60), -- เทาเข้ม
		SubText = Color3.fromRGB(100, 100, 110),
		Hover = Color3.fromRGB(230, 230, 240),
		HoverChange = 0.03,
	}
	end,
	[84] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(84)return {
		Name = "Diamond",
		Accent = Color3.fromRGB(173, 216, 230), -- ฟ้าใส
	
		AcrylicMain = Color3.fromRGB(240, 250, 255), -- ฟ้าขาว
		AcrylicBorder = Color3.fromRGB(200, 220, 230),
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(225, 245, 255)), -- ฟ้าขาวอ่อน
			ColorSequenceKeypoint.new(1, Color3.fromRGB(180, 220, 255)) -- ฟ้าเงินเข้ม
		},
		AcrylicNoise = 0.85,
	
		TitleBarLine = Color3.fromRGB(160, 200, 230), -- ฟ้าเงินหรูหรา
		Tab = Color3.fromRGB(210, 230, 255), -- ฟ้าใสสวยงาม
	
		Element = Color3.fromRGB(225, 245, 255), -- ฟ้าขาวคริสตัล
		ElementBorder = Color3.fromRGB(180, 220, 255), -- ฟ้าเงินเข้ม
		InElementBorder = Color3.fromRGB(150, 200, 240), -- ฟ้าเงินลึก
		ElementTransparency = 0.85,
	
		ToggleSlider = Color3.fromRGB(225, 245, 255),
		ToggleToggled = Color3.fromRGB(50, 70, 90),
	
		SliderRail = Color3.fromRGB(225, 245, 255),
	
		DropdownFrame = Color3.fromRGB(200, 225, 245),
		DropdownHolder = Color3.fromRGB(160, 200, 230),
		DropdownBorder = Color3.fromRGB(140, 180, 220),
		DropdownOption = Color3.fromRGB(225, 245, 255),
	
		Keybind = Color3.fromRGB(225, 245, 255),
	
		Input = Color3.fromRGB(225, 245, 255),
		InputFocused = Color3.fromRGB(180, 220, 255),
		InputIndicator = Color3.fromRGB(160, 200, 230),
	
		Dialog = Color3.fromRGB(190, 230, 250),
		DialogHolder = Color3.fromRGB(170, 210, 240),
		DialogHolderLine = Color3.fromRGB(150, 190, 230),
		DialogButton = Color3.fromRGB(200, 240, 255),
		DialogButtonBorder = Color3.fromRGB(210, 230, 255),
		DialogBorder = Color3.fromRGB(180, 220, 255),
		DialogInput = Color3.fromRGB(160, 200, 240),
		DialogInputLine = Color3.fromRGB(225, 245, 255),
	
		Text = Color3.fromRGB(50, 70, 90), -- ฟ้าเทาเข้ม
		SubText = Color3.fromRGB(100, 130, 160),
		Hover = Color3.fromRGB(225, 245, 255),
		HoverChange = 0.04,
	}
	end,
	[85] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(85)return {
		Name = "Cyberpunk",
		Accent = Color3.fromRGB(255, 20, 147), -- ชมพูนีออนสด
	
		AcrylicMain = Color3.fromRGB(10, 10, 20), -- ดำลึก
		AcrylicBorder = Color3.fromRGB(30, 30, 60), -- ดำอมฟ้า
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(25, 0, 50)), -- ม่วงเข้ม
			ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 20, 80)) -- น้ำเงินนีออน
		},
		AcrylicNoise = 0.90,
	
		TitleBarLine = Color3.fromRGB(255, 20, 147), -- ชมพูนีออน
		Tab = Color3.fromRGB(0, 200, 255), -- ฟ้านีออน
	
		Element = Color3.fromRGB(75, 0, 130), -- ม่วงเข้ม
		ElementBorder = Color3.fromRGB(139, 0, 255), -- ม่วงนีออน
		InElementBorder = Color3.fromRGB(0, 200, 255), -- ฟ้านีออน
		ElementTransparency = 0.80,
	
		ToggleSlider = Color3.fromRGB(255, 20, 147),
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(139, 0, 255),
	
		DropdownFrame = Color3.fromRGB(75, 0, 130),
		DropdownHolder = Color3.fromRGB(30, 0, 60),
		DropdownBorder = Color3.fromRGB(20, 0, 40),
		DropdownOption = Color3.fromRGB(255, 20, 147),
	
		Keybind = Color3.fromRGB(255, 20, 147),
	
		Input = Color3.fromRGB(0, 200, 255),
		InputFocused = Color3.fromRGB(20, 0, 40),
		InputIndicator = Color3.fromRGB(139, 0, 255),
	
		Dialog = Color3.fromRGB(30, 0, 60),
		DialogHolder = Color3.fromRGB(20, 0, 40),
		DialogHolderLine = Color3.fromRGB(15, 0, 30),
		DialogButton = Color3.fromRGB(75, 0, 130),
		DialogButtonBorder = Color3.fromRGB(255, 20, 147),
		DialogBorder = Color3.fromRGB(139, 0, 255),
		DialogInput = Color3.fromRGB(0, 200, 255),
		DialogInputLine = Color3.fromRGB(139, 0, 255),
	
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(180, 180, 180),
		Hover = Color3.fromRGB(255, 20, 147),
		HoverChange = 0.05,
	}
	end,
	[86] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(86)return {
		Name = "Neon Grid",
		Accent = Color3.fromRGB(0, 255, 140), -- เขียวนีออนสด
	
		AcrylicMain = Color3.fromRGB(10, 10, 15), -- ดำเข้ม
		AcrylicBorder = Color3.fromRGB(30, 30, 40), -- ดำเงา
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 255, 140)), -- เขียวไซเบอร์
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 200, 255)), -- ฟ้านีออน
			ColorSequenceKeypoint.new(1, Color3.fromRGB(139, 0, 255)) -- ม่วงนีออน
		},
		AcrylicNoise = 0.92,
	
		TitleBarLine = Color3.fromRGB(0, 255, 140), -- เขียวไฟฟ้า
		Tab = Color3.fromRGB(0, 200, 255), -- ฟ้าเรืองแสง
	
		Element = Color3.fromRGB(30, 30, 40), -- ดำอมฟ้า
		ElementBorder = Color3.fromRGB(0, 255, 140), -- เขียวสด
		InElementBorder = Color3.fromRGB(0, 200, 255), -- ฟ้านีออน
		ElementTransparency = 0.85,
	
		ToggleSlider = Color3.fromRGB(139, 0, 255), -- ม่วงสด
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(0, 255, 140),
	
		DropdownFrame = Color3.fromRGB(30, 30, 40),
		DropdownHolder = Color3.fromRGB(20, 20, 30),
		DropdownBorder = Color3.fromRGB(0, 255, 140),
		DropdownOption = Color3.fromRGB(0, 200, 255),
	
		Keybind = Color3.fromRGB(0, 255, 140),
	
		Input = Color3.fromRGB(139, 0, 255),
		InputFocused = Color3.fromRGB(0, 255, 140),
		InputIndicator = Color3.fromRGB(0, 200, 255),
	
		Dialog = Color3.fromRGB(30, 30, 40),
		DialogHolder = Color3.fromRGB(20, 20, 30),
		DialogHolderLine = Color3.fromRGB(10, 10, 20),
		DialogButton = Color3.fromRGB(0, 255, 140),
		DialogButtonBorder = Color3.fromRGB(0, 200, 255),
		DialogBorder = Color3.fromRGB(139, 0, 255),
		DialogInput = Color3.fromRGB(0, 200, 255),
		DialogInputLine = Color3.fromRGB(0, 255, 140),
	
		Text = Color3.fromRGB(255, 255, 255),
		SubText = Color3.fromRGB(180, 180, 180),
		Hover = Color3.fromRGB(0, 255, 140),
		HoverChange = 0.05,
	}
	end,
	[87] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(87)return {
		Name = "Hacker Mode",
		Accent = Color3.fromRGB(0, 255, 0), -- เขียวนีออนสด
	
		AcrylicMain = Color3.fromRGB(5, 10, 5), -- ดำมืดสุด
		AcrylicBorder = Color3.fromRGB(20, 40, 20), -- เขียวเข้ม
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 150, 0)), -- เขียวเข้ม
			ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 255, 0)) -- เขียวนีออน
		},
		AcrylicNoise = 0.95,
	
		TitleBarLine = Color3.fromRGB(0, 255, 0), -- เขียวนีออน
		Tab = Color3.fromRGB(0, 200, 0), -- เขียวสด
	
		Element = Color3.fromRGB(10, 30, 10), -- เขียวเข้ม
		ElementBorder = Color3.fromRGB(0, 255, 0), -- เขียวนีออน
		InElementBorder = Color3.fromRGB(0, 200, 0), -- เขียวไฟฟ้า
		ElementTransparency = 0.80,
	
		ToggleSlider = Color3.fromRGB(0, 255, 0), -- เขียวนีออน
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(0, 200, 0),
	
		DropdownFrame = Color3.fromRGB(10, 30, 10),
		DropdownHolder = Color3.fromRGB(5, 20, 5),
		DropdownBorder = Color3.fromRGB(0, 255, 0),
		DropdownOption = Color3.fromRGB(0, 200, 0),
	
		Keybind = Color3.fromRGB(0, 255, 0),
	
		Input = Color3.fromRGB(0, 255, 0),
		InputFocused = Color3.fromRGB(5, 20, 5),
		InputIndicator = Color3.fromRGB(0, 200, 0),
	
		Dialog = Color3.fromRGB(10, 30, 10),
		DialogHolder = Color3.fromRGB(5, 20, 5),
		DialogHolderLine = Color3.fromRGB(5, 15, 5),
		DialogButton = Color3.fromRGB(0, 255, 0),
		DialogButtonBorder = Color3.fromRGB(0, 200, 0),
	...
	[88] = function()
	local maui,script,require,getfenv,setfenv=ImportGlobals(88)
	return {
		Name = "Glitch Core Squad",
		Accent = Color3.fromRGB(255, 0, 255), -- ม่วงไฟฟ้า (Glitch highlight)

		-- Background & UI --
		AcrylicMain = Color3.fromRGB(10, 5, 20), -- ดำม่วงเข้ม (Dark UI base)
		AcrylicBorder = Color3.fromRGB(40, 20, 80), -- ม่วง-น้ำเงิน (UI border)
		AcrylicGradient = ColorSequence.new{
		ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 255)), -- ชมพูบั๊ก (Glitch start)
		ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 255)), -- ฟ้าบั๊ก (Digital mid)
		ColorSequenceKeypoint.new(1, Color3.fromRGB(139, 0, 255)) -- ม่วงแตกๆ (Synergy end)
		},
		AcrylicNoise = 0.98, -- Distortion effect

		-- Navigation --
		TitleBarLine = Color3.fromRGB(255, 0, 255), -- ม่วงกลิตช์ (Team header)
		Tab = Color3.fromRGB(0, 255, 255), -- ฟ้าดิจิทัล (Active tab)

		-- Unit Modules --
		Element = Color3.fromRGB(50, 20, 80), -- ม่วงเข้มแตก (Skill cards)
		ElementBorder = Color3.fromRGB(255, 0, 255), -- ชมพูแฮก (Module borders)
		InElementBorder = Color3.fromRGB(0, 255, 255), -- ฟ้าบั๊ก (Active module)
		ElementTransparency = 0.85, -- Holographic effect

		-- Interactive Elements --
		ToggleSlider = Color3.fromRGB(139, 0, 255), -- ม่วงสด (Auto Farm toggle)
		ToggleToggled = Color3.fromRGB(0, 0, 0), -- Black (Disabled state)
		SliderRail = Color3.fromRGB(255, 0, 255), -- Magenta (XP progress)

		-- Event Systems --
		DropdownFrame = Color3.fromRGB(50, 20, 80), -- ม่วงเข้ม (Event selector)
		DropdownHolder = Color3.fromRGB(30, 10, 60), -- ม่วงกลาง (Event list)
		DropdownBorder = Color3.fromRGB(255, 0, 255), -- Glitch outline
		DropdownOption = Color3.fromRGB(0, 255, 255), -- Cyan (Selected event)

		-- Combat HUD --
		Keybind = Color3.fromRGB(0, 255, 255), -- ฟ้าบั๊ก (Skill hotkeys)
		Input = Color3.fromRGB(255, 0, 255), -- Magenta (Command input)
		InputFocused = Color3.fromRGB(20, 0, 40), -- ม่วงดำ (Active input)
		InputIndicator = Color3.fromRGB(0, 255, 255), -- Cyan (Typing caret)

		-- Battle Dialog --
		Dialog = Color3.fromRGB(50, 20, 80), -- ม่วงเข้ม (Damage popups)
		DialogHolder = Color3.fromRGB(30, 10, 60), -- ม่วงกลาง (Log background)
		DialogHolderLine = Color3.fromRGB(20, 0, 40), -- ม่วงดำ (Log separator)
		DialogButton = Color3.fromRGB(0, 255, 255), -- Cyan (Confirm button)
		DialogButtonBorder = Color3.fromRGB(255, 0, 255), -- Magenta (Button edge)
		DialogBorder = Color3.fromRGB(139, 0, 255), -- Purple (Popup outline)

		-- Text & Effects --
		Text = Color3.fromRGB(255, 255, 255), -- White (Primary text)
		SubText = Color3.fromRGB(200, 200, 255), -- Lavender (Secondary text)
		Hover = Color3.fromRGB(255, 0, 255), -- Magenta (Hover effects)
		HoverChange = 0.06 -- Glitch transition speed
	}
	end
	[89] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(89)return {
		Name = "Abstract Chaos",
		Accent = Color3.fromRGB(187, 255, 0), -- เขียวเหลืองพิษแสบตา
	
		AcrylicMain = Color3.fromRGB(47, 79, 79), -- สีเขียวเทาทึบ
		AcrylicBorder = Color3.fromRGB(255, 69, 0), -- ส้มแดงแบบเตือนภัย
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 0, 255)), -- ม่วงชมพูพิสดาร
			ColorSequenceKeypoint.new(0.33, Color3.fromRGB(173, 216, 230)), -- ฟ้าพาสเทลอ่อนผิดที่ผิดทาง
			ColorSequenceKeypoint.new(0.66, Color3.fromRGB(0, 0, 0)), -- ดำมืดสุด
			ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 255, 0)) -- เหลืองสดเตือนภัย
		},
		AcrylicNoise = 1.00, -- เพิ่มความยุ่งเหยิง
	
		TitleBarLine = Color3.fromRGB(255, 20, 147), -- ชมพูไฟฟ้า
		Tab = Color3.fromRGB(0, 255, 255), -- ฟ้าสว่างสุดขั้ว
	
		Element = Color3.fromRGB(255, 140, 0), -- ส้มสะท้อนแสง
		ElementBorder = Color3.fromRGB(75, 0, 130), -- ม่วงเข้มเกินเหตุ
		InElementBorder = Color3.fromRGB(0, 255, 140), -- เขียวนีออนผิดธรรมชาติ
		ElementTransparency = 0.70, -- โปร่งใสแปลก ๆ
	
		ToggleSlider = Color3.fromRGB(0, 191, 255), -- ฟ้าน้ำทะเล
		ToggleToggled = Color3.fromRGB(255, 0, 0), -- แดงสดสุดขั้ว
	
		SliderRail = Color3.fromRGB(123, 104, 238), -- น้ำเงินอมม่วงแบบสุ่ม
	
		DropdownFrame = Color3.fromRGB(255, 105, 180), -- ชมพูแปลก ๆ
		DropdownHolder = Color3.fromRGB(50, 205, 50), -- เขียวสดผิดที่ผิดทาง
		DropdownBorder = Color3.fromRGB(178, 34, 34), -- แดงมืดแรงเกินไป
		DropdownOption = Color3.fromRGB(240, 230, 140), -- เหลืองพาสเทลแบบสุ่ม
	
		Keybind = Color3.fromRGB(138, 43, 226), -- ม่วงประหลาด
	
		Input = Color3.fromRGB(189, 183, 107), -- เหลืองอมเขียวแบบฝุ่น
		InputFocused = Color3.fromRGB(70, 130, 180), -- ฟ้าน้ำเงินผิดที่
		InputIndicator = Color3.fromRGB(255, 69, 0), -- ส้มแดงสะดุดตา
	
		Dialog = Color3.fromRGB(255, 250, 205), -- เหลืองอ่อนซีด ๆ
		DialogHolder = Color3.fromRGB(240, 128, 128), -- ชมพูอ่อนผิดปกติ
		DialogHolderLine = Color3.fromRGB(176, 196, 222), -- ฟ้าพาสเทลนุ่มนวลผิดที่ผิดเวลา
		DialogButton = Color3.fromRGB(255, 99, 71), -- แดงอมส้มสุดขีด
		DialogButtonBorder = Color3.fromRGB(218, 112, 214), -- ม่วงอ่อนแบบไร้ทิศทาง
		DialogBorder = Color3.fromRGB(154, 205, 50), -- เขียวมะนาวขัดตา
		DialogInput = Color3.fromRGB(210, 105, 30), -- น้ำตาลแดงแปลก ๆ
		DialogInputLine = Color3.fromRGB(0, 255, 255), -- ฟ้าสดสุดขั้ว
	
		Text = Color3.fromRGB(0, 0, 0), -- ดำสุด
		SubText = Color3.fromRGB(255, 255, 255), -- ขาวสุด
		Hover = Color3.fromRGB(250, 128, 114), -- ชมพูอมแดงแบบสุ่ม
		HoverChange = 0.10, -- เปลี่ยนเร็วขึ้นผิดปกติ
	}
	end,
	[90] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(90)return {
		Name = "Deep Space",
		Accent = Color3.fromRGB(80, 0, 150), -- ม่วงลึกลับ
	
		AcrylicMain = Color3.fromRGB(10, 5, 30), -- ดำสนิทอมฟ้า
		AcrylicBorder = Color3.fromRGB(40, 20, 80), -- น้ำเงินเข้ม
		AcrylicGradient = ColorSequence.new{
			ColorSequenceKeypoint.new(0, Color3.fromRGB(5, 5, 20)), -- ดำสนิท
			ColorSequenceKeypoint.new(0.5, Color3.fromRGB(40, 0, 80)), -- ม่วงอวกาศ
			ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 100)) -- น้ำเงินจักรวาล
		},
		AcrylicNoise = 0.90,
	
		TitleBarLine = Color3.fromRGB(100, 0, 200), -- ม่วงเข้ม
		Tab = Color3.fromRGB(0, 50, 150), -- น้ำเงินลึก
	
		Element = Color3.fromRGB(20, 10, 60), -- ม่วงน้ำเงินมืด
		ElementBorder = Color3.fromRGB(80, 0, 150), -- ม่วงสว่าง
		InElementBorder = Color3.fromRGB(0, 80, 200), -- น้ำเงินไฟฟ้า
		ElementTransparency = 0.85,
	
		ToggleSlider = Color3.fromRGB(100, 50, 200), -- ม่วงอวกาศ
		ToggleToggled = Color3.fromRGB(0, 0, 0),
	
		SliderRail = Color3.fromRGB(0, 50, 150),
	
		DropdownFrame = Color3.fromRGB(20, 10, 60),
		DropdownHolder = Color3.fromRGB(10, 5, 30),
		DropdownBorder = Color3.fromRGB(0, 50, 150),
		DropdownOption = Color3.fromRGB(100, 0, 200),
	
		Keybind = Color3.fromRGB(100, 50, 200),
	
		Input = Color3.fromRGB(80, 0, 150),
		InputFocused = Color3.fromRGB(0, 50, 150),
		InputIndicator = Color3.fromRGB(100, 0, 200),
	
		Dialog = Color3.fromRGB(20, 10, 60),
		DialogHolder = Color3.fromRGB(10, 5, 30),
		DialogHolderLine = Color3.fromRGB(5, 5, 20),
		DialogButton = Color3.fromRGB(0, 50, 150),
		DialogButtonBorder = Color3.fromRGB(100, 0, 200),
		DialogBorder = Color3.fromRGB(80, 0, 150),
		DialogInput = Color3.fromRGB(0, 50, 150),
		DialogInputLine = Color3.fromRGB(100, 50, 200),
	
		Text = Color3.fromRGB(220, 220, 255), -- ขาวน้ำเงิน
		SubText = Color3.fromRGB(180, 180, 220),
		Hover = Color3.fromRGB(100, 50, 200),
		HoverChange = 0.05,
	}
	end
